...
export const MEMOJI_FIGURINE_IDLE_URL = `${import.meta.env.BASE_URL}memoji-figurine-idle.png`;
export const MEMOJI_FIGURINE_WAVE_URL = `${import.meta.env.BASE_URL}memoji-figurine-wave.png`;
