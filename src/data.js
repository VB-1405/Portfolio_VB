...
export const MEMOJI_FIGURINE_IDLE_URL = `${import.meta.env.BASE_URL}memoji-figurine-idle-alpha.png?v=5`;
export const MEMOJI_FIGURINE_WAVE_URL = `${import.meta.env.BASE_URL}memoji-figurine-wave-alpha.png?v=5`;
