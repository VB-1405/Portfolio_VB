...
export default function AvatarDevControls({ onChange }) {
  ...
  const desk = useControls("Desk Rig", {
    deskPositionX: { value: DESK_RIG_POSITION[0], min: -3, max: 3, step: 0.05 },
    deskPositionY: { value: DESK_RIG_POSITION[1], min: -3, max: 3, step: 0.05 },
    deskPositionZ: { value: DESK_RIG_POSITION[2], min: -3, max: 3, step: 0.05 },
