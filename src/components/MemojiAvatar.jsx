...
/** Desktop-only Memoji figurine — fixed bottom-left with wave on hover/click. */
export default function MemojiAvatar() {
  ...
  return (
    <div className="fixed left-0 bottom-0 z-30 pointer-events-none w-[min(34vw,320px)] h-[min(72vh,560px)]">
      <button
        type="button"
