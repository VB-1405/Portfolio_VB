...
/** Desktop-only 3D Memoji avatar from avatar.glb — fixed bottom-left. */
export default function GlbAvatar() {
  ...
  return (
    <div className="fixed left-0 bottom-0 z-30 pointer-events-none w-[min(36vw,340px)] h-[min(78vh,600px)] overflow-visible">
      <button
        type="button"
        onPointerMove={(e) => {
