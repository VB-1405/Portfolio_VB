...
import {
  NAV_ITEMS, CREDIBILITY, SOCIAL_LINKS, EXPERIENCE, PROJECTS,
  CERTS, EDUCATION, STUDY_GUIDES, WRITEUPS, PROFILE,
} from "./data";
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-4xl mx-auto px-6 py-2.5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-white">
                ...
                <span className="text-slate-400 font-normal">Cyber Security Analyst/Engineer</span>
              </span>
            </div>
        ...
        <Section id="about" label="Summary" title="About">
          <p className="text-sm text-slate-400 leading-relaxed">
            Cybersecurity Master's student at CSUDH (expected Dec 2026) with hands-on SOC experience —
            log analysis, threat hunting, and incident response using enterprise SIEM platforms. I build
            the tools I use: automation pipelines, threat intel aggregators, and detection tuning, backed
            by CTF results in the top 1% globally on TryHackMe.
          </p>
        </Section>
